...
simulation_results_n50 <- obtain_individual_categorical_data_simulation_statistics(x = parameters$x, prob = parameters$prob,
                                                                                   x_factors = parameters$x_factor, 
                                                                                   y_vector = c(1, 1, 1))

replicates <- 1
while (replicates < 1000){
  simulation_results_replicate <- obtain_individual_categorical_data_simulation_statistics(x = parameters$x, prob = parameters$prob,
                                                                                           x_factors = parameters$x_factor,
                                                                                           y_vector = c(1, 1, 1))
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n50_j3.csv')
...
simulation_results_n100 <- obtain_individual_categorical_data_simulation_statistics(x = parameters$x, prob = parameters$prob,
                                                                                    x_factors = parameters$x_factor,
                                                                                    y_vector = c(1, 1, 1))
replicates <- 1
while (replicates < 1000){
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n100_j3.csv')
...
simulation_results_n200 <- obtain_individual_categorical_data_simulation_statistics(x = parameters$x, prob = parameters$prob,
                                                                                    x_factors = parameters$x_factor,
                                                                                    y_vector = c(1, 1, 1))
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n200_j3.csv')
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n50_j4.csv')
write.csv(simulation_results_n50)
sink()
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n100_j4.csv')
write.csv(simulation_results_n100)
sink()
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n200_j4.csv')
write.csv(simulation_results_n200)
sink()
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n50_j5.csv')
write.csv(simulation_results_n50)
sink()
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n100_j5.csv')
write.csv(simulation_results_n100)
sink()
...
sink('output_data/Individual_data_simulation/Categorical_data/simulation_results_n200_j5.csv')
write.csv(simulation_results_n200)
sink()
